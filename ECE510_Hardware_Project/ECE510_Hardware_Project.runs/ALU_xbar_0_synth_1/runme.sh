...
HD_PWD='C:/Users/natha/source/repos/ECE-510-Final-Hardware-Project/ECE510_Hardware_Project/ECE510_Hardware_Project.runs/ALU_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_xbar_0.tcl
