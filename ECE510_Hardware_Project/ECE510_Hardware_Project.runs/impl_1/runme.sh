...
HD_PWD='C:/Users/natha/source/repos/ECE-510-Final-Hardware-Project/ECE510_Hardware_Project/ECE510_Hardware_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CNTxALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CNTxALU.tcl -notrace
